...
st.title("圖片元件")  # 指令,參數(圖片檔案路徑,寬度)
# st.image指令,參數(圖片檔案路徑,寬度)
st.image("image/Go-Youn-Jung-1.jpeg", width=300)

image_folder = "image"  # 資料夾名稱
image_files = os.listdir(image_folder)  # 取得資料夾中所有檔案名稱
...
for image_file in image_files:  # 顯示所有圖片
    # 除了width,還有use_container_width可以使用,會將圖片設為容器寬度
